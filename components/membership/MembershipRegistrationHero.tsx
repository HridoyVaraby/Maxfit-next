...
export default function MembershipRegistrationHero() {
  return (
    <section className="relative pt-20 pb-16 md:pb-24">
      ...
      <div className="absolute inset-0 z-0">
        <div className="relative h-full w-full">
          <Image
            src="https://images.pexels.com/photos/3768916/pexels-photo-3768916.jpeg?auto=compress&cs=tinysrgb&w=1920"
            alt="MAXFIT Gym Membership Registration"
            fill
            priority
      ...
      <div className="container-custom relative z-10 text-white pt-16 md:pt-24">
        <div className="max-w-3xl mx-auto text-center animate-fadeInUp">
          ...
          <p className="text-lg md:text-xl mb-8 text-gray-300">
            Complete your registration to join the MAXFIT community and start your fitness journey
          </p>
        </div>
      </div>
    </section>
